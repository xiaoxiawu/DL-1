...
image = caffe.io.load_image(caffe_root + 'data/yearbook/M/1983_Massachusetts_Plymouth_Plymouth-Carver_37-4.png')
...
print 'predicted class is:', output_prob.argmax()+ 1905
